...
MSG = {
    "ENG": {
        ...
        "AR6-7": ("Funcion '{}' has no return-command anywhere in its body.", ERROR),
    ...
    "FIN": {
        ...
        "AR6": ("Aliohjelman '{}' päätason lopusta puuttuu return-komento.", ERROR),
        ...
        "AR6-7": ("Aliohjelmassa '{}' ei ole lainkaan return-komentoa.", ERROR),
